...
partial class WinScroll
{
    ...
    private void InitializeComponent()
    {
        ...
        this.windowCheck.Text = "Enable hotkeys";
        this.tooltip.SetToolTip(this.windowCheck, "Enable window hotkeys, ctrl+alt+{up/down/left/right}");
        ...
        this.label10.Text = "ctrl+alt+{down/up}: hide/show";
        // 
        // WinScroll
        // 
